...
def get_cron_pipeline_matrix():
    ...
    pipeline_jobs = [
        ...
        },
        {
            ...
            'status': calc_status('04:30 AM') if calc_status('04:30 AM') == 'Completed' else 'Standby'
        },
        {
            'time': '09:30 – 16:00',
            ...
            'status': calc_status('09:30 – 16:00')
        },
        {
            'time': '5-Min Cadence',

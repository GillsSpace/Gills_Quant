...
7. run `docker compose up -d --build` to start api service to receive the Schwab tokens database file at `secrets/tokens.db`.

8. run `tailscale serve --bg 8000` on gill_01. Take note of url.
